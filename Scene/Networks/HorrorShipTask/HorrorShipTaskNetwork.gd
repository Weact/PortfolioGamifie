extends NetworkBase
class_name HorrorShipTaskNetwork

func is_class(value: String): return value == "HorrorShipTaskNetwork" or .is_class(value)
func get_class() -> String: return "HorrorShipTaskNetwork"
