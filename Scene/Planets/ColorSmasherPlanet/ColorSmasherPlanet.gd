...
func create_spatial_planet_game_name() -> void:
	if PlanetGameNameScene != null:
		...
		spatial_instance.set_position(Vector2(get_position().x - 250, get_position().y - 600))
...
func create_spatial_game_description() -> void:
	if PlanetGameDescriptionScene != null:
		...
		spatial_description_instance.set_position(Vector2(get_position().x, get_position().y - 250))
...
func create_spatial_networks() -> void:
	if PlanetGameNetworksPath != null:
		...
		spatial_networks_game.set_position(Vector2(get_position().x - 350, get_position().y + 400))
